...
const STYLE = `
  ...
  * { box-sizing: border-box; font-family: system-ui, "Microsoft YaHei", sans-serif; }
  ...
  .slot { font-size: 13px; line-height: 1.5; padding: 4px 6px; border-radius: 4px; margin-bottom: 3px; }
  .keep { background: #f0f9f0; }
  .sub { background: #fff7e6; }
  .unresolved { background: #fdeeee; }
  ...
  .sub-line { display: block; line-height: 1.6; }
  .own { color: #1a7f37; font-weight: 600; }
  .miss { color: #c0392b; }
  .quote { color: #999; }
